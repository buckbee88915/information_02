                            ...
                            <h5></h5>
                                ...
                                <?php if ($level == 'supervisor') { ?>
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-md-3 mb-md-2">
                                            <div class="alert alert-primary" role="alert"><span class="extra-sm"> จำนวนห้องประชุมที่จองทั้งหมด </span>
                                                <?php
                                                // include("db_connect.php"); // เรียกใช้งานไฟล์เชื่อมต่อกับฐานข้อมูล
                                                $db_con = connect(); // เชื่อมต่อกับฐานข้อมูล
                                                ($query =
                                    ...
                                    $level == 'non-supervisor'
                                        ...
                                        <div class="row mb-2">
                                            ...
                                            <div class="col-md-3 mb-md-2">
                                                <div class="alert alert-primary" role="alert"><span class="extra-sm"> จำนวนห้องประชุม </span>
                                                    <?php
                                                    include 'db_connect.php'; // เรียกใช้งานไฟล์เชื่อมต่อกับฐานข้อมูล
                                                    $db_con = connect(); // เชื่อมต่อกับฐานข้อมูล
                                                    ($query =
